function neueZutat(){
    ...
    neuer_block.querySelector('label[for="zutaten_id"]').setAttribute("for","zutaten_id"+rand);
    neuer_block.querySelector('select[id="zutaten_id"]').setAttribute("id","zutaten_id"+rand);
};