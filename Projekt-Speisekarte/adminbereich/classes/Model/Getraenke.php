...
class Getraenke extends SGModelAbstract{
    ...
    protected string $sqlOrder = " order by aktiv, `name` asc ";
    ...
    protected string $sqlAlleAktivenElementeTeil2 = " g, bz_speise_kategorie bz, kategorie k , einheit e where g.aktiv= 1 and g.getraenk_id=bz.getraenk_id and bz.aktiv =1 and k.kategorie_id=bz.kategorie_id and k.aktiv=1 and e.einheit_id=bz.einheit_id order by typ, k.reihenfolge, g.name, preis;" ;
}